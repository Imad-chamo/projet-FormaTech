                ...
                <tbody>
                    ...
                    <?php foreach ($formations as $formation) : ?>
                        <tr>
                            ...
                            <td><?= $formation->getModulesList($pdo) ?></td>
                            <td><?= ($formation->getis_public() ? 'Public' : 'Private') ?></td>
                            <td>
                                <a href="deleteformation.php?id=<?= $formation->getId() ?>" class="btn btn-danger" onclick="return confirm('Etes-vous sûr de voilour supprimer cette formation ?')">Supprimer</a>
